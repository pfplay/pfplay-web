    ...
    <>
      <div className="flex justify-between items-center" style={{ marginTop: '20px' }}>
        ...
        <span className="flex items-center text-sm">
          {address ? (
            <>
              <div className="flex justify-center items-center px-5" style={{ height: '36px', border: 'solid 1px #545454', borderRadius: '4px' }}>
                <div className="group relative inline-block">
                  <div className="bg-primary inline-flex rounded ptext-base ">
                    <Image src="/icons/Ethereum.png" alt="Ethereum" width="20px" height="20px" style={{ marginTop: '1px' }} />
                    <p className="ml-1">
                  ...
                  <div
                    ...
                    onClick={disconnect}
                  >
                    <span className="absolute top-[-3px] left-1/2 -z-10 h-2 w-2 -translate-x-1/2 rotate-45 rounded-sm" style={{ backgroundColor: '#111111' }}></span>
          ...
          <button
            style={{ height: '36px', marginLeft: '16px', border: 'solid 1px #545454', borderRadius: '4px', backgroundColor: '#2F2F2F' }}
            className="text-sm flex justify-center items-center px-5"
            onClick={connectWithMetamask}
          >
            <Image src="/icons/icn_add.png" alt="Ethereum" width="15px" height="15px" style={{ marginTop: '1px' }} /> <p className="ml-1">추가 연결</p>
          </button>
        </span>
      </div>
      {address ? (
        <div className="grid grid-cols-5 gap-5 mt-7 scrollbar-hide overflow-y-auto" style={{ maxHeight: '200px' }}>
      ...
      <div className="grid grid-cols-5 gap-5 mt-7 scrollbar-hide overflow-y-auto" style={{ maxHeight: '190px' }}>
        <div className=" bg-gray-500" style={{ maxWidth: '200px', aspectRatio: 'auto 1/1' }}></div>
        <div className=" bg-gray-500" style={{ maxWidth: '200px', aspectRatio: 'auto 1/1' }}></div>
        <div className=" bg-gray-500" style={{ maxWidth: '200px', aspectRatio: 'auto 1/1' }}></div>
        <div className=" bg-gray-500" style={{ maxWidth: '200px', aspectRatio: 'auto 1/1' }}></div>
