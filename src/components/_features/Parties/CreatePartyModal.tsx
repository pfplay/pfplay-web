                ...
                <div className='px-10'>
                  <div className='flex items-center justify-between'>
                    <div className='w-[70px]'>
                      <p className='text-grey-200 relative'>
                        파티 이름<span className='text-red-300 absolute -right-1 -top-1'>*</span>
                      </p>
                    </div>
                    <div className='w-[537px] py-3 px-4 bg-grey-700 rounded flex items-center justify-between'>
                      <input
                        type='text'
                        className='bg-transparent text-grey-200 text-[15px]'
                  ...
                  <div className='flex items-center justify-between my-12'>
                    ...
                    <div className='w-[537px] h-[92px] py-3 px-4 bg-grey-700 rounded flex flex-col justify-between'>
                      <textarea
                        className='bg-transparent text-grey-200 text-[15px] w-full resize-none'
                        placeholder='22년 여돌 노래 정산 신곡 모음'
                      />
                      <p className='text-grey-400 text-[15px] flex justify-end'>
                        <span className='text-red-300'>18</span>/30
                      </p>
                    </div>
                  </div>
                  <div className='flex items-center gap-x-8'>
                    <div className='flex items-center'>
                      ...
                      <div className='w-[313px] py-3 px-4 bg-grey-700 rounded flex items-center justify-between'>
                        <input
                          type='text'
                          className='bg-transparent text-grey-200 text-[15px]'
                          placeholder='22년 여돌 노래 정산 신곡 모음'
                    ...
                    <div className='flex items-center'>
                      <div className='w-[60px] mr-6'>
                        <p className='text-grey-200 relative leading-tight'>
                          디제잉 제한시간
                          <span className='text-red-300 absolute -right-1 -top-1'>*</span>
                        </p>
                      </div>
                      <div className='py-3 px-4 bg-grey-700 rounded flex items-center justify-center w-[86px]'>
                        <input
                          type='text'
                          className='bg-transparent text-grey-200 text-[15px] w-3'
                          placeholder='7'
                        />
                      </div>
                      <span className='ml-2 text-grey-200'>분</span>
                    </div>
                  </div>
                  <div className='flex items-center justify-end mb-10 mt-12'>
                    <button className='py-3 px-[105px] bg-gradient-red'>
                      <span className='text-grey-50 font-bold'>저장</span>
                    </button>
                  </div>
                </div>
              </Dialog.Panel>
