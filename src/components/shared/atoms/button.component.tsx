...
import Typography, { TypographyType } from '@/components/shared/atoms/typography.component';
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'flex max-w-full h-max items-center justify-center gap-[8px] rounded-[4px] whitespace-nowrap',
