import {
  ...
  CrewsClient,
  BlockedCrew,
  GetCrewProfileSummaryRequest,
  GetCrewProfileSummaryResponse,
...
export default class CrewsService extends HTTPClient implements CrewsClient {
  ...
  public getCrewProfileSummary({ crewId }: GetCrewProfileSummaryRequest) {
    return this.get<GetCrewProfileSummaryResponse>(`${this.ROUTE_V1}/${crewId}/profile/summary`);
  }
}
