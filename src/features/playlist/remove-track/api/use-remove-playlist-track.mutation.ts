...
import { RemoveTrackFromPlaylistRequestParams } from '@/shared/api/http/types/playlists';

export const useRemovePlaylistTrack = () => {
  const queryClient = useQueryClient();

  return useMutation<void, AxiosError<APIError>, RemoveTrackFromPlaylistRequestParams>({
