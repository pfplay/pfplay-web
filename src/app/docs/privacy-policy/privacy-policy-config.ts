...
export const privacyPolicyConfig = [
  ...
  },
  {
    ...
    type: 'default',
    heads: [
      'PFPlay는 고객의 피드백과 서비스에 대한 변경 사항을 반영하기 위해 필요한 경우 본 개인정보 처리방침을 업데이트합니다. PFPlay는 본 방침의 변경 사항을 게시할 때 방침 상단의 "최종 업데이트" 날짜를 수정할 것입니다. 본 방침에 중대한 변경이 있거나 https://pfplay.xyz 가 귀하의 개인 데이터를 사용하는 방식이 변경되는 경우, PFPlay는 변경 사항이 적용되기 전에 해당 변경 사항을 눈에 잘 띄게 게시하거나 귀하에게 직접 통지함으로써 귀하에게 통지할 것입니다. 본 개인정보 보호정책을 주기적으로 검토하여 https://pfplay.xyz 가 귀하의 정보를 어떻게 보호하고 있는지 알아보시기 바랍니다.',
    ],
  },
  {
    ...
    type: 'default',
    heads: [
      '기술 또는 지원 관련 질문이 있는 경우 gm@pfplay.xyz 로 이메일을 보내주십시오.',
      '개인정보 보호 관련 우려 사항, 불만 사항 또는 https://pfplay.xyz 의 데이터 보호 책임자에 대한 질문이 있는 경우, gm@pfplay.xyz 으로 이메일을 보내주시면 30일 이내에 질문이나 우려 사항에 대해 답변해 드리겠습니다.',
    ],
  },
