...
const AvatarSettingsPage = () => {
  return (
    <section className='absolute-user-form-section max-h-tablet'>
      <BackButton text='뭘 입고 놀아볼까요?' className='absolute top-10 left-[60px]' />
      <div className='h-full flexCol justify-start max-w-screen-desktop mx-auto gap-10 py-[120px] pb-10 px-[60px]'>
        <AvatarSettingForm />
      </div>
    </section>
  );
